...
exports.login = async (req, res) => {
  ...
  res.send({
    code: 20000,
    message: '登录成功！',
    data: { userInfo: loginInfo.userinfo, access_token: loginInfo.accessToken, refresh_token: loginInfo.refreshToken }
  })
}
...
exports.refresh = async (req, res) => {
  ...
  res.send({
    code: 20000,
    message: '刷新成功！',
    data: { userInfo: refreshInfo.userinfo, access_token: refreshInfo.accessToken, refresh_token: refreshToken }
  })
}
