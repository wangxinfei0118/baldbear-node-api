...
const pid = joi.string().required().error(new Error('pid不能为空'))
const user_id = joi.string().required().error(new Error('userId不能为空'))
const note_id = joi.string().required().error(new Error('noteId不能为空'))
